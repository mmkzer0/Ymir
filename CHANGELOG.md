...
- VDP1: Add one-pixel offset to vertical coordinates of normal and scaled sprites when rendering high-resolution modes with deinterlacing enabled. Fixes gaps in Sonic Jam and Astra Superstars. (#784, #853)
